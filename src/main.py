...
# Default to <repo>/results, but allow per-run isolation (e.g. Optuna trials) via
# the EPYMARL_RESULTS_DIR env var so parallel runs don't collide in results/sacred.
